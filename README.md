...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.20184000.svg)](https://doi.org/10.5281/zenodo.20184000)
[![Status](https://img.shields.io/badge/status-phase%200%20v0.1.0-orange.svg)](https://github.com/joonhai-official/icon-empirical/releases/tag/v0.1.0)
...
- GitHub release: [`v0.1.0`](https://github.com/joonhai-official/icon-empirical/releases/tag/v0.1.0)
- Zenodo archive: [`10.5281/zenodo.20184000`](https://doi.org/10.5281/zenodo.20184000)
- ICON framework repository: [`joonhai-official/icon`](https://github.com/joonhai-official/icon)
- ICON framework Zenodo archive: [`10.5281/zenodo.20184015`](https://doi.org/10.5281/zenodo.20184015)
